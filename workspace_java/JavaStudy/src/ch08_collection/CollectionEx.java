...
public class CollectionEx {
	...
	public static void main(String[] args) {
		...
		System.out.println(arraySinger(playList));
	}
	public static ArrayList<String> arraySinger(ArrayList<String> arr) {
		ArrayList<String> result = new ArrayList<>();
		HashSet<String> singerList = new HashSet<>();
		for (int i = 0; i < arr.size(); i++) {
			String [] temp = arr.get(i).split(":");
			singerList.add(temp[1]);
			}
		result.addAll(singerList);
