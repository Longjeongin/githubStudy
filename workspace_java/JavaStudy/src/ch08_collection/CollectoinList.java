...
public class CollectoinList {
	...
	public static void main(String[] args) {
		...
		// <> <-- 이 부분은 제네릭(Generic)이라하며 코드에서 타입의 안정성을
		// 보장할 수 있으며, 불필요한 캐스팅을 줄이기 위해 만들어짐
		...
		stu.set(0, "민호");
		System.out.println(students);
		System.out.println(stu); // 얕은 복사는 주소를 복사(공유)하기 때문에 둘다 같음
		// 2. 깊은 복사1
